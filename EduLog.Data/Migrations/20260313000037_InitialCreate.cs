    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ClassGroups_Syllabi_SyllabusId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SyllabusWeeks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SyllabusWeeks_Syllabi_SyllabusId",
                        column: x => x.SyllabusId,
                        principalTable: "Syllabi",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SyllabusWeekId = table.Column<int>(type: "int", nullable: false),
                    Title = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Assignments_SyllabusWeeks_SyllabusWeekId",
                        column: x => x.SyllabusWeekId,
                        principalTable: "SyllabusWeeks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WeekResources", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WeekResources_SyllabusWeeks_SyllabusWeekId",
                        column: x => x.SyllabusWeekId,
                        principalTable: "SyllabusWeeks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InstructorNote = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Submissions_ClassGroups_ClassGroupId",
                        column: x => x.ClassGroupId,
                        principalTable: "ClassGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Python programlama dili eğitimi", "Python" },
                    { 2, "C# programlama dili eğitimi", "C#" },
                    { 3, "SQL Server veritabanı yönetimi eğitimi", "SQL Server" },
                    { 4, "Unity oyun motoru eğitimi", "Unity" },
                    { 5, "Web geliştirme eğitimi", "Web Yazılım" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Assignments_SyllabusWeekId",
                table: "Assignments",
                column: "SyllabusWeekId");

            migrationBuilder.CreateIndex(
                name: "IX_ClassEnrollments_ClassGroupId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassGroups_JoinCode",
                table: "ClassGroups",
                column: "JoinCode",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ClassGroups_SyllabusId",
                table: "ClassGroups",
                column: "SyllabusId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Submissions_ClassGroupId",
                table: "Submissions",
                column: "ClassGroupId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SyllabusWeeks_SyllabusId",
                table: "SyllabusWeeks",
                column: "SyllabusId");

            migrationBuilder.CreateIndex(
                name: "IX_WeekResources_SyllabusWeekId",
                table: "WeekResources",
                column: "SyllabusWeekId");
        }
